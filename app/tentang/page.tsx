...
const tujuan = [
  ...
  },
  {
    ...
    deskripsi:
      "Menyediakan panduan langkah-langkah mitigasi sebelum, saat, dan sesudah bencana terjadi.",
  },
  {
    judul: "Respons Cepat",
    deskripsi:
        ...
        >
          <div className="relative max-w-3xl mx-auto">
            ...
            <p className="text-slate-300 text-lg leading-relaxed">
              SIGAP hadir sebagai platform digital terpadu untuk membantu
              masyarakat Indonesia memahami, mempersiapkan diri, dan merespons
              bencana alam dengan lebih cepat dan tepat.
            </p>
          </div>
        </section>
          ...
          <section className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <h2 className="text-2xl font-bold text-white mb-4">
                Apa itu{" "}
                <span style={{ color: "#4ade80" }}>SIGAP?</span>
              </h2>

              <p className="text-slate-400 leading-relaxed">
                SIGAP adalah Sistem Informasi dan Edukasi Kebencanaan berbasis
                web yang dirancang untuk memberikan informasi, edukasi,
                panduan mitigasi, dan layanan darurat kepada masyarakat
                Indonesia.
              </p>
            </div>
