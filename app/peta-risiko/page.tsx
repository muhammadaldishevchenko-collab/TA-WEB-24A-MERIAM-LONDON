...
const wilayahData = [
  ...
  {
  id: 3, nama: "Lampung", risiko: ["Gempa Bumi", "Tsunami", "Banjir", "Longsor"], level: "sangat-tinggi",
  detail: "Provinsi Lampung berdekatan dengan Selat Sunda dan zona pertemuan lempeng Indo-Australia dan Eurasia. Wilayah pesisir memiliki potensi tsunami, sementara daerah perbukitan berisiko longsor dan banjir saat musim hujan.",
  koordinat: { x: 18, y: 72 },
},
  {
    id: 4, nama: "Jakarta,jawa Barat,", risiko: ["Banjir", "Gempa"], level: "tinggi",
    detail: "Banjir tahunan akibat urbanisasi masif dan pendangkalan sungai.",
    koordinat: { x: 32, y: 55 },
  },
  {
    id: 5, nama: "Jawa Tengah & DIY", risiko: ["Gempa", "Erupsi", "Longsor"], level: "tinggi",
    detail: "Gunung Merapi aktif. Gempa Yogyakarta 2006 menelan ribuan korban.",
    koordinat: { x: 40, y: 55 },
  },
  {
    id: 6, nama: "Jawa Timur", risiko: ["Gempa", "Erupsi", "Banjir"], level: "tinggi",
    detail: "Gunung Semeru dan Bromo aktif. Pesisir selatan rawan tsunami.",
    koordinat: { x: 50, y: 53 },
  },
  {
    id: 7, nama: "Sulawesi Tengah", risiko: ["Gempa", "Tsunami", "Likuifaksi"], level: "sangat-tinggi",
    detail: "Gempa Palu 2018 memicu tsunami dan likuifaksi yang menghancurkan pemukiman.",
    koordinat: { x: 68, y: 38 },
  },
  {
    id: 8, nama: "Maluku", risiko: ["Gempa", "Tsunami", "Erupsi"], level: "sangat-tinggi",
    detail: "Zona subduksi aktif. Gunung Ibu dan Dukono sering erupsi.",
    koordinat: { x: 82, y: 38 },
  },
  {
    id: 9, nama: "Papua", risiko: ["Gempa", "Banjir", "Longsor"], level: "tinggi",
    detail: "Sesar aktif di pegunungan tengah. Banjir bandang sering di lembah-lembah.",
    koordinat: { x: 90, y: 48 },
  },
  {
    id: 10, nama: "Kalimantan", risiko: ["Kebakaran Hutan", "Banjir"], level: "sedang",
    detail: "Kebakaran gambut saat musim kering sangat merusak. Banjir di pesisir.",
    koordinat: { x: 58, y: 38 },
  },
  {
    id: 11, nama: "Bali & NTB", risiko: ["Gempa", "Erupsi", "Tsunami"], level: "tinggi",
